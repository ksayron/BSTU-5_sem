...
int main() {
    ...
    char cmdLine[256];
    sprintf_s(cmdLine, "Lab3.exe 100");

    

    BOOL createdProcesses[processAmount]{ FALSE, FALSE, FALSE };

    createdProcesses[0] = CreateProcessA(cmdLine, nullptr, nullptr, nullptr, FALSE, 0, nullptr, nullptr, &processStartUpInfo[0], &processInfo[0]);
    ...
    createdProcesses[2] = CreateProcessA(exeFile, (LPSTR)" 100", nullptr, nullptr, FALSE, 0, nullptr, nullptr, &processStartUpInfo[2], &processInfo[2]);
