...
// Pyramid.cpp: определяет поведение классов для приложения.
//
...
// Создание CPyramidApp

CPyramidApp::CPyramidApp() noexcept
{
	...
	SetAppID(_T("Pyramid.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CPyramidApp

CPyramidApp theApp;


// Инициализация CPyramidApp
...
BOOL CPyramidApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CPyramidDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CPyramidView));
	if (!pDocTemplate)
		return FALSE;
	...
	m_pMainWnd->SetWindowText(_T("Pyramid"));
...
// Обработчики сообщений CPyramidApp
