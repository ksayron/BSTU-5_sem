...
CREATE TABLE PRODUCTS
     (MFR_ID CHAR(3) NOT NULL,--код производителя
  PRODUCT_ID CHAR(5) NOT NULL,--код товара
 DESCRIPTION VARCHAR(20) NOT NULL,--описание
       PRICE DECIMAL(9,2) NOT NULL,--цена
 QTY_ON_HAND INTEGER NOT NULL,--кол-во на складе
 PRIMARY KEY (MFR_ID, PRODUCT_ID));


CREATE TABLE OFFICES
     (OFFICE INTEGER NOT NULL,--код офиса
        CITY VARCHAR(15) NOT NULL,--имя города
      REGION VARCHAR(10) NOT NULL,--регион
         MGR INTEGER,--менеджер
      TARGET DECIMAL(9,2),--план продаж
       SALES DECIMAL(9,2) NOT NULL,--сколько продали
 PRIMARY KEY (OFFICE));


CREATE TABLE SALESREPS--продавцы
   (EMPL_NUM INTEGER NOT NULL,--код сотрудника
             CHECK (EMPL_NUM BETWEEN 101 AND 199),
        NAME VARCHAR(15) NOT NULL,--имя
         AGE INTEGER,--возраст
  REP_OFFICE INTEGER,--офис
       TITLE VARCHAR(10),--должность 
   HIRE_DATE DATE NOT NULL,--когда наняли
     MANAGER INTEGER,--босс сотрудника
       QUOTA DECIMAL(9,2),--квота
       SALES DECIMAL(9,2) NOT NULL,--скок продали
...
CREATE TABLE CUSTOMERS--клиенты(компании)
   (CUST_NUM INTEGER    NOT NULL,--код клиента
    COMPANY  VARCHAR(20) NOT NULL,--компания/имя клиента
    CUST_REP INTEGER,--кто из компании обслуживает
...
CREATE TABLE ORDERS
  (ORDER_NUM INTEGER NOT NULL,--комер заказа
             CHECK (ORDER_NUM > 100000),
  ORDER_DATE DATE NOT NULL,--дата заказа
        CUST INTEGER NOT NULL,--клиент
         REP INTEGER,--кто продал
         MFR CHAR(3) NOT NULL,--код производителя товара
     PRODUCT CHAR(5) NOT NULL,--код товара
         QTY INTEGER NOT NULL,--скок купили
      AMOUNT DECIMAL(9,2) NOT NULL,--сумма денежная
